...
class DDPGAgent:
    ...
    def __init__(self, env, hidden_size_l1=256, hidden_size_l2=256, actor_optimizer='Adam', critic_optimizer='Adam',
        ...
        self.target_actor = Actor(hidden_size_l1=hidden_size_l1, hidden_size_l2=hidden_size_l2, output_size=self.action_space)
    ...
    def train(self, batch_size):
        ...
        :return:
        """
        state_batch, action_batch, reward_batch, next_state_batch, _, _, _ = self.long_memory.sample(batch_size=batch_size)
        ...
        # Critic loss
        with tf.GradientTape() as tape:
            target_critic_value = reward_batch + self.gamma * self.target_critic([next_state_batch, self.target_actor(next_state_batch)])
